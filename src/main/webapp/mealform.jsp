...
<div>
    ...
    <form method="POST" action="/meals/edit" accept-charset="UTF-8">
    ...
    <table>
        ...
        <tr class="datetime">
            ...
            <td>
                <input id="datetime" name="datetime" type="datetime-local" class="datetimepicker" value="<%=TimeUtil.toString(meal.getDateTime())%>" />
            </td>
        </tr>
